...
SDS_DED_FUN<-function(odm_forms,odm_items,odm_code,odm_sdtm,odm_code_item,Lib_items,asses,Lib_codes,sdtm,mapped_items){
  ...
  #SDTM Variable
  # ifelse(!is.na(Lib_items$SDTM.Variable.Name.x),Lib_items$SDTM.Variable.Name <- Lib_items$SDTM.Variable.Name.x,
  #        ifelse(!is.na(Lib_items$SDTM.Variable.Name.y),Lib_items$SDTM.Variable.Name <- Lib_items$SDTM.Variable.Name.y,
  #               ifelse(!is.na(Lib_items$SDTM.Variable.Name.x.x),Lib_items$SDTM.Variable.Name <- Lib_items$SDTM.Variable.Name.x.x, 
  #                      ifelse(!is.na(Lib_items$SDTM.Variable.Name.y.y),Lib_items$SDTM.Variable.Name <- Lib_items$SDTM.Variable.Name.y.y,
  #                             ifelse(!is.na(Lib_items$SDTM.Variable.Name.y.y.y),Lib_items$SDTM.Variable.Name <- Lib_items$SDTM.Variable.Name.y.y.y,
  #                                    ifelse(!is.na(Lib_items$SDTM.Variable.Name.x.x.x),Lib_items$SDTM.Variable.Name <- Lib_items$SDTM.Variable.Name.x.x.x,"Missing"))))))-> Lib_items$SDTM.Variable.Name
  # 
  ...
  #Subset
  #Lib_items %>% select(Name,Item.Name,Label...15,Codelist,Item.OID.x,Item.OID.y,Item.OID.x.x,Item.OID.y.y, Item.OID.x.x.x,Item.OID.y.y.y, SDTM.Variable.Name, SDTM.SuppQual.Desc,SDTM.SuppQual.Desc.x,SDTM.SuppQual.Desc.y,SDTM.SuppQual.Desc.y.y,SDTM.SuppQual.Desc.x.x,SDTM.SuppQual.Desc.x.x.x,SDTM.SuppQual.Desc.y.y.y,Mandatory,Codelist,Question,DED.Form.OID,SAS.Field.Name)->Library_items
  ...
  #Collapse SDTM.SuppQual.Desc
  # ifelse(!is.na(Library_items$SDTM.SuppQual.Desc),Library_items$SDTM.SuppQual.Desc <- Library_items$SDTM.SuppQual.Desc,
  #        ifelse(!is.na(Library_items$SDTM.SuppQual.Desc.x),Library_items$SDTM.SuppQual.Desc <- Library_items$SDTM.SuppQual.Desc.x,
  #               ifelse(!is.na(Library_items$SDTM.SuppQual.Desc.y),Library_items$SDTM.SuppQual.Desc  <- Library_items$SDTM.SuppQual.Desc.y,
  #                      ifelse(!is.na(Library_items$SDTM.SuppQual.Desc.x.x),Library_items$SDTM.SuppQual.Desc  <- Library_items$SDTM.SuppQual.Desc.x.x, 
  #                             ifelse(!is.na(Library_items$SDTM.SuppQual.Desc.y.y),Library_items$SDTM.SuppQual.Desc  <- Library_items$SDTM.SuppQual.Desc.y.y,
  #                                    ifelse(!is.na(Library_items$SDTM.SuppQual.Desc.y.y.y),Library_items$SDTM.SuppQual.Desc  <- Library_items$SDTM.SuppQual.Desc.y.y.y
  #                                           ,ifelse(!is.na(Library_items$SDTM.SuppQual.Desc.x.x.x),Library_items$SDTM.SuppQual.Desc  <- Library_items$SDTM.SuppQual.Desc.x.x.x,"")))))))-> Library_items$SDTM.SuppQual.Desc 
  ...
  #Library_items %>% select(Name,Item.Name,Label,Item_OID, SAS.Field.Name,SDTM.Variable.Name,SDTM.SuppQual.Desc  ,Mandatory,Codelist,Question,DED.Form.OID)->Library_items
  ...
  #ifelse(!is.na(Library_items$SDTM.Variable.Name.y),Library_items$SDTM.Variable.Name  <- Library_items$Item_OID.y,Library_items$SDTM.Variable.Name.x)-> Library_items$SDTM.Variable.Name 
  ...
  #trim the SDTM Qual that we put into the SDTM variable so it only has the variable after the equals sign
  #Library_items$SDTM.Variable.Name<-gsub(".*?\\= ","",Library_items$SDTM.Variable.Name)
  ...
  #SDTM Variable
  # ifelse(!is.na(asses$SDTM.Variable.Name.x),asses$SDTM.Variable.Name <- asses$SDTM.Variable.Name.x,
  #        ifelse(!is.na(asses$SDTM.Variable.Name.y),asses$SDTM.Variable.Name <- asses$SDTM.Variable.Name.y,
  #               ifelse(!is.na(asses$SDTM.Variable.Name.x.x),asses$SDTM.Variable.Name <- asses$SDTM.Variable.Name.x.x, 
  #                      ifelse(!is.na(asses$SDTM.Variable.Name.y.y),asses$SDTM.Variable.Name <- asses$SDTM.Variable.Name.y.y,
  #                             ifelse(!is.na(asses$SDTM.Variable.Name.y.y.y),asses$SDTM.Variable.Name <- asses$SDTM.Variable.Name.y.y.y,
  #                                    ifelse(!is.na(asses$SDTM.Variable.Name.x.x.x),asses$SDTM.Variable.Name <- asses$SDTM.Variable.Name.x.x.x,"Missing"))))))-> asses$SDTM.Variable.Name
  ...
  #Collapse SDTM.SuppQual.Desc
  # ifelse(!is.na(asses$SDTM.SuppQual.Desc),asses$SDTM.SuppQual.Desc <- asses$SDTM.SuppQual.Desc,
  #        ifelse(!is.na(asses$SDTM.SuppQual.Desc.x),asses$SDTM.SuppQual.Desc <- asses$SDTM.SuppQual.Desc.x,
  #               ifelse(!is.na(asses$SDTM.SuppQual.Desc.y),asses$SDTM.SuppQual.Desc  <- asses$SDTM.SuppQual.Desc.y,
  #                      ifelse(!is.na(asses$SDTM.SuppQual.Desc.x.x),asses$SDTM.SuppQual.Desc  <- asses$SDTM.SuppQual.Desc.x.x, 
  #                             ifelse(!is.na(asses$SDTM.SuppQual.Desc.y.y),asses$SDTM.SuppQual.Desc  <- asses$SDTM.SuppQual.Desc.y.y,
  #                                    ifelse(!is.na(asses$SDTM.SuppQual.Desc.y.y.y),asses$SDTM.SuppQual.Desc  <- asses$SDTM.SuppQual.Desc.y.y.y
  #                                           ,ifelse(!is.na(asses$SDTM.SuppQual.Desc.x.x.x),asses$SDTM.SuppQual.Desc  <- asses$SDTM.SuppQual.Desc.x.x.x,"")))))))-> asses$SDTM.SuppQual.Desc 
  ...
  #ded %>% select(Item.OID,DED.Form.OID, DED.Item.Group.SDTM.Domain) -> ded_sdtm_domain
  ...
  # ded_sdtm_domain %>% 
  #   dplyr::rename(SDTM.Domain = DED.Item.Group.SDTM.Domain)->ded_sdtm_domain
  ...
  #subset
  #ded_sdtm_domain %>% select(concat,SDTM.Domain) ->ded_sdtm_domain
  ...
  # form_oids %>% select (Name, DED.Form.OID) ->form_oids
  ...
  #select
  #mapped_items_comb %>% select(Item.Name.OID,SDTM.Variable.Name, Question, Lilly.DED.Form.OID, Study.Form.Name, Mandatory, mapping)->mapped_items_comb_2
  ...
  #update 04_06_2022        
  #asses$Item.Name <-     asses$Item_OID
  #asses$Item.Active.Status <-"A"
  
  #ded %>% select(DED.Form.OID, DED.Item.Group.SDTM.Domain) -> ded_sdtm_domain_as
  ded %>% select(DED.Form.OID) -> ded_sdtm_domain_as
  
  # ded_sdtm_domain_as %>% 
  #   dplyr::rename(SDTM.Domain = DED.Item.Group.SDTM.Domain)->ded_sdtm_domain_as
  if(nrow(asses)>0){
    asses %>%
    ...
    #asses %>% select(Item_OID,Question,DED.Form.OID,SDTM.Variable.Name,Name,Mandatory,Item.Name,SDTM.Domain,Item.Active.Status)->asses
  ...
  # #Library target column
  # 	CDB_items_map %>%
  #   left_join(crf_lib, by = c("Item_OID" = "SOURCE_COLUMN"))->CDB_items_map		
  # 	
  # 			      #remove duplicate rows
  #         CDB_items_map[!duplicated(CDB_items_map), ] -> CDB_items_map	
  #Transpose
  ...
  #CDB %>%
  # group_by(Item.Name) %>%
  #summarise_each(funs(first(.[!is.na(.)])))->CDB2
  ...
  # ded %>% filter (!is.na(Check.All.Question), !is.na(Codelist.Ref)) ->bool_code
  # 
  # bool_code%>%select(Item.OID, Codelist.Ref)->bool_code
  ...
  #ODM Update- don't need this step since codlelists already derived for us
  #remove slashes to get the codelist name, we have to do this twice
  # 
  # bool2$Codelist.Ref<-sub("\\\\[^\\\\]+$", "", bool2$Codelist.Ref)
  # bool2$Codelist.Ref<-sub("\\\\[^\\\\]+$", "", bool2$Codelist.Ref)
  #End ODM Update
  ...
  #set code ref for bolean to codetrim and codelist  value and then drop that column
  
  
  # Library_items_bool$code_trim<- ifelse(!is.na(Library_items_bool$Codelist.Ref), Library_items_bool$Codelist.Ref, Library_items_bool$code_trim)
  # 
  # Library_items_bool$Codelist<- ifelse(!is.na(Library_items_bool$Codelist.Ref), Library_items_bool$Codelist.Ref, Library_items_bool$Codelist)	       
  ...
  #fill in code for Bolean codes
  
  # Library_items_code$Choice.Code<- ifelse(!is.na(Library_items_code$Codelist.Ref), Library_items_code$Label, Library_items_code$Choice.Code)
  # Library_items_code$Choice.Label<- ifelse(!is.na(Library_items_code$Codelist.Ref), Library_items_code$Label, Library_items_code$Choice.Label)
  ...
  #ODM Update
  # ded %>%
  #     select (Item.OID, Codelist.Ref)->ded_code_Ref
  # 
  # gsub("\\\\.*","",ded_code_Ref$Codelist.Ref)->ded_code_Ref$trim_ref
  # #######New
  # gsub(".*\\\\","",ded_code_Ref$Codelist.Ref)->ded_code_Ref$trim_ref_label
  # #####
  # Library_items_code %>%
  ...
  #replace codelist OIDS with subsets codes
  # ifelse((Library_items_code_ded2$Codelist.OID != Library_items_code_ded2$trim_ref_label ),Library_items_code_ded2$Codelist.OID <- Library_items_code_ded2$trim_ref_label,Library_items_code_ded2$Codelist.OID ) -> Library_items_code_ded2$Codelist.OID
  ...
  #Library_items_code_ded2 %>% select(-code_trim,-code_trim_num)->Library_items_code_ded2
  ...
  # ifelse(!is.na(Library_items_code_ded2$Code.x),Library_items_code_ded2$DED_Code <- Library_items_code_ded2$Code.x,
  #        ifelse(!is.na(Library_items_code_ded2$Code.y),Library_items_code_ded2$DED_Code <- Library_items_code_ded2$Code.y,"Missing"))-> Library_items_code_ded2$DED_Code
  ...
  # ifelse(!is.na(Library_items_code_ded2$Long.Decode.x),Library_items_code_ded2$DED_Long_Code <- Library_items_code_ded2$Long.Decode.x,
  #        ifelse(!is.na(Library_items_code_ded2$Long.Decode.y),Library_items_code_ded2$DED_Long_Code <- Library_items_code_ded2$Long.Decode.y,"Missing"))-> Library_items_code_ded2$DED_Long_Code
  ...
  #Library_items %>%
  # filter(DED_Long_Code == "Missing") -> Library_items_m
  
  #subset
  #Library_items_code_ded2 %>% select(Name,Item.Name,Label,Item_OID, SDTM.Variable.Name,SDTM.SuppQual.Desc, Mandatory,Codelist,Choice.Code,Choice.Label,Codelist.OID,DED_Code,DED_Long_Code,Item.SAS.Field.Name )->Library_items_code_ded2 
  ...
  #mapped_items_cl %>% select(Study.Form.Name,Lilly.DED.Form.OID,Item.Name.OID,SDTM.Variable.Name,Codelist.Name,Default.Value,Logic.to.Hard.Code.Value.in.Dataset, Value.to.be.Hard.Coded)->mapped_items_cl 
  ...
  #ded_sub %>% select(DED.Form.OID,Item.OID,Question,Mandatory, SDTM.Variable.Name,SDTM.SuppQual.Desc)->ded_cl ## updated
  ...
  #ifelse(is.na(mapped_items_cl$SDTM.Variable.Name), gsub(".*?\\=","",mapped_items_cl$SDTM.SuppQual.Desc),mapped_items_cl$SDTM.Variable.Name)->mapped_items_cl$SDTM.Variable.Name
  
  #replace any spaces
  searchString <- ' '
  replacementString <- ''
  #mapped_items_cl$SDTM.Variable.Name = sub(searchString,replacementString,mapped_items_cl$SDTM.Variable.Name)
  ...
  #Codelist,Choice.Code,Choice.Label,Item.Name,
  
  #subset
  #mapped_items_cl %>% select(Name,Label,Item_OID, SDTM.Variable.Name,SDTM.SuppQual.Desc, Mandatory,Codelist.OID,DED_Code,DED_Long_Code,DED.Form.OID )->mapped_items_cl 
  ...
  #combi_cl%>% select(Name,Item.Name,Label,Item_OID, Item.SAS.Field.Name,SDTM.Variable.Name,SDTM.SuppQual.Desc, Mandatory,Codelist,	Choice.Code,	Choice.Label,Codelist.OID,DED_Code,DED_Long_Code,DED.Form.OID)->combi_cl
  ...
  #Trim any SDTM Variable names that have the logic so we only get what is after the equals sign
  #gsub(".*?\\=","",combi_cl$SDTM.Variable.Name)->combi_cl$SDTM.Variable.Name
  
  #replace any spaces
  searchString <- ' '
  replacementString <- ''
  #combi_cl$SDTM.Variable.Name = sub(searchString,replacementString,combi_cl$SDTM.Variable.Name)
  ...
  #Code lists	
  #combi_cl %>%
  # strict_left_join(ded_code_active, by = c("Codelist.OID" = "Codelist.OID"))->combi_cl
  ...
  if(nrow(asses)>0){
    ...
    #asses_cl %>% select(Name,Item.Name,Label,Item_OID,SAS.Field.Name,SDTM.Variable.Name,SDTM.SuppQual.Desc,Mandatory,Codelist,Question,DED.Form.OID,Item.Active.Status)->asses_cl
    ...
    #trim codelist names to keep the subset information
    
    #asses_cl$Codelist<-gsub('.*\\\\ ?(\\w+)', '\\1', asses_cl$Codelist)
    
    
    #asses_cl$Codelist<-gsub("\\\\.*","",asses_cl$Codelist)
    ...
    #join data  
    # 		  		asses_cl %>%
    #   left_join(asses_cd, by = c("Item_OID" = "Item.External.ID"))->asses_codes
    ...
    #order columns
    #asses_codes %>% select(Name,	Item.Name,	Label,	Item_OID,	SAS.Field.Name,SDTM.Variable.Name,	SDTM.SuppQual.Desc,	Mandatory,	Codelist,	Choice.Code,	Choice.Label,	Codelist.OID,	DED_Code,	DED_Long_Code,	DED.Form.OID,	Item.Active.Status,	Codelist.Active.Status)->asses_codes
    ...
    #combi_cl%>% select(Name,	Item.Name,	Label,	Item_OID,	SAS.Field.Name,SDTM.Variable.Name,	SDTM.SuppQual.Desc,	Mandatory,	Codelist,	Choice.Code,	Choice.Label,	Codelist.OID,	DED_Code,	DED_Long_Code,	DED.Form.OID,	SDTM.Domain,Item.Active.Status,	Codelist.Active.Status)->combi_cl
  ...
  #Library_items %>% select(Name,Item.Name,Label,Item_OID,Item.SAS.Field.Name,SDTM.Variable.Name,SDTM.SuppQual.Desc,Mandatory,Codelist,Question,DED.Form.OID,Item.Active.Status)->Library_items
  ...
  observeEvent(input$Show_Report_Btn_Click, {
    ...
    output$download_all <- downloadHandler(
      ...
      content = function(filename){
        ...
        # if(session$clientData == "https://shiny.am.lilly.com/MANTIS/")
        #{
        # write.table(DED_SDS_items, file = "//lrlhps/data/MANTIS/Data/Veeva/Output/DED_SDS_items.csv",append=T,sep=",",row.names = F)
        # write.table(DED_SDS_codelist, file = "//lrlhps/data/MANTIS/Data/Veeva/Output/DED_SDS_codelist.csv",append=T,sep=",",row.names = F)
        # write.table(CDB_Mappings, file = "//lrlhps/data/MANTIS/Data/Veeva/Output/CDB_Mappings.csv",append=T,sep=",",row.names = F)
        #write.table(Rules, file = "//lrlhps/data/MANTIS/Data/Veeva/Output/Rules.csv",append=T,sep=",",row.names = F)
        #   }
        #write.xlsx(x=DED_SDS_items, file = "//lrlhps/data/MANTIS/Data/Veeva/Output/DED_SDS_items.xlsx", sheetName="DED_SDS_items", col.names=TRUE, row.names=F, append=TRUE)
        #write.xlsx(x=DED_SDS_codelist, file = "//lrlhps/data/MANTIS/Data/Veeva/Output/DED_SDS_codelist.xlsx", sheetName="DED_SDS_codelist", col.names=TRUE, row.names=F, append=TRUE)
        #write.xlsx(x=CDB_Mappings, file = "//lrlhps/data/MANTIS/Data/Veeva/Output/CDB_Mappings.xlsx", sheetName="CDB_Mappings", col.names=TRUE, row.names=F, append=TRUE)
